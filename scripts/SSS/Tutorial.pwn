...
public OnPlayerViewContainerOpt(playerid, containerid)
{
	...
	return CallLocalFunction("tut_OnPlayerViewContainerOpt", "d", playerid);
}
#if defined _ALS_OnPlayerViewContainerOpts
...
forward tut_OnPlayerViewContainerOpt(playerid);
