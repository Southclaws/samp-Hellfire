...
//#define ENABLE_LOAD_DEBUG_PRINT TRUE
...
LoadMap(filename[])
{
        ...
        #if defined ENABLE_LOAD_DEBUG_PRINT 
        printf(">> MAPS: file: \"%s\" LOADING!", filename);
        new file_line=0;
        #endif
        ...
        while(fread(file, str))
        {
                #if defined ENABLE_LOAD_DEBUG_PRINT 
                file_line++;
                printf(" %d - Total Objects - Loading line %d", CountDynamicObjects(), file_line);
                #endif
